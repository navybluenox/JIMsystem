$(function(){
    ...
    _val.pageFun.editWorkList = {
        onload:function(){
            ...
            var span = detailTable.find('[name="detail_interval_' + detailIndex + '"]').siblings("span");
            ...
            tr.find("table").closest("td").css({"display":"inline-block","overflow":"auto","width":detailTable.width() + "px"});
