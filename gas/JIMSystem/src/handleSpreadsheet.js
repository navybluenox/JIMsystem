            ...
            .then(function(){
                ...
                .map(obj => {
                    return {
                        ...
                        "data":workLists.map(workList => {
                            return {
                                "workList":workList,
                                "setting":workList.getShiftTableAsSpreadsheetSetting()
                            };
                        })
                    };
                })
                .forEach(function(tableDataObj){
                    var table = [];
                    var spreadsheet = new Spreadsheet("shiftTableWork",obj.sheetName,table);
                    var mergeSetting = [];
                    var borderSetting = [];
                    var sizeSetting = [];
                    var start = timeInfo.start;
