...
var CollectionInfo = function (_Datapiece) {
    ...
    _createClass(CollectionInfo, [{
        ...
        value: function getClass() {
            var classNamePairList = [{ name: "collectionInfo", class: CollectionInfo }, { name: "fileInfo", class: FileInfo }, { name: "shiftTableUser", class: ShiftTableUser }, { name: "shiftTableWork", class: ShiftTableWork }, { name: "systemConfig", class: SystemConfig }, { name: "user", class: User }, { name: "userGroup", class: UserGroup }, { name: "workAssign", class: WorkAssign }, { name: "workGroup", class: WorkGroup }, { name: "workList", class: WorkList }, { name: "workNotAssined", class: WorkNotAssigned }];
...
var FileInfo = function (_Datapiece2) {
    _inherits(FileInfo, _Datapiece2);

    function FileInfo(datapieceObj) {
        _classCallCheck(this, FileInfo);

        return _possibleConstructorReturn(this, Object.getPrototypeOf(FileInfo).call(this, datapieceObj, "fileInfo"));
    }

    return FileInfo;
}(Datapiece);

var ShiftTableUser = function (_Datapiece3) {
    _inherits(ShiftTableUser, _Datapiece3);

    function ShiftTableUser(datapieceObj) {
        _classCallCheck(this, ShiftTableUser);

        return _possibleConstructorReturn(this, Object.getPrototypeOf(ShiftTableUser).call(this, datapieceObj, "shiftTableUser"));
    }

    return ShiftTableUser;
}(Datapiece);

var ShiftTableWork = function (_Datapiece4) {
    _inherits(ShiftTableWork, _Datapiece4);

    function ShiftTableWork(datapieceObj) {
        _classCallCheck(this, ShiftTableWork);

        return _possibleConstructorReturn(this, Object.getPrototypeOf(ShiftTableWork).call(this, datapieceObj, "shiftTableWork"));
    }

    return ShiftTableWork;
}(Datapiece);

var SystemConfig = function (_Datapiece5) {
    _inherits(SystemConfig, _Datapiece5);
...
var User = function (_Datapiece6) {
    _inherits(User, _Datapiece6);
...
var UserGroup = function (_Datapiece7) {
    _inherits(UserGroup, _Datapiece7);

    function UserGroup(datapieceObj) {
        _classCallCheck(this, UserGroup);

        return _possibleConstructorReturn(this, Object.getPrototypeOf(UserGroup).call(this, datapieceObj, "userGroup"));
    }

    return UserGroup;
}(Datapiece);

var WorkAssign = function (_Datapiece8) {
    _inherits(WorkAssign, _Datapiece8);

    function WorkAssign(datapieceObj) {
        _classCallCheck(this, WorkAssign);

        return _possibleConstructorReturn(this, Object.getPrototypeOf(WorkAssign).call(this, datapieceObj, "workAssign"));
    }

    return WorkAssign;
}(Datapiece);

var WorkGroup = function (_Datapiece9) {
    _inherits(WorkGroup, _Datapiece9);

    function WorkGroup(datapieceObj) {
        _classCallCheck(this, WorkGroup);

        return _possibleConstructorReturn(this, Object.getPrototypeOf(WorkGroup).call(this, datapieceObj, "workGroup"));
    }

    return WorkGroup;
}(Datapiece);

var WorkList = function (_Datapiece10) {
    _inherits(WorkList, _Datapiece10);

    function WorkList(datapieceObj) {
        _classCallCheck(this, WorkList);

        return _possibleConstructorReturn(this, Object.getPrototypeOf(WorkList).call(this, datapieceObj, "workList"));
    }

    return WorkList;
}(Datapiece);

var WorkNotAssined = function (_Datapiece11) {
    _inherits(WorkNotAssined, _Datapiece11);

    function WorkNotAssined(datapieceObj) {
        _classCallCheck(this, WorkNotAssined);

        return _possibleConstructorReturn(this, Object.getPrototypeOf(WorkNotAssined).call(this, datapieceObj, "workNotAssined"));
    }

    return WorkNotAssined;
}(Datapiece);