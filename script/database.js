        ...
        rowContents.forEach(function(_rowContent,rowIndex){
            ...
            _tdMatrix[rowIndex] = rowContent.map(function(cell,cellIndex){
                ...
                if(cell.workAssignId === "_blank"){
                    ...
                    td.children("span").text(workList.getValue("nameShort"));
                    td.css({
                ...
                td.css({"min-width":"1em"}).addClass("shiftTableContent").children("span").css({"padding":"1ex 0.5em","white-space":"pre","display":"block"});
                return td;
            });
        });
