...
class User extends Datapiece{
    ...
    getIncharge(isAll,getFromData){
        isPresent = isPresent === undefined ? false : isPresent;
        getFromData = getFromData === undefined ? false : getFromData;
        if(this._incharge === undefined || getFromData)  this._incharge = Datapiece.getServer().getDataById(this.getValue("inchargeId"));
