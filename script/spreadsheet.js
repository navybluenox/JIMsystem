var Spreadsheet = (function(){
    ...
    return class Spreadsheet{
        ...
        downloadPdf(option){
            option = option || {};
            return runServerFun("Script.handleSpreadsheetInterface",["downloadPdf",this.getFileInfo().getValue("fileId"),this.getSheetName(),[option]]).then(function(obj){
                var blob = new Blob([obj.blob],{"type":"application/pdf"});
                downloadFile(blob,obj.name);
            });
        }
