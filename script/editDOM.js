...
class Modalwindow{
    constructor(option){
        ...
        [
            ...
            {key:"disableClickBackground",value:""},
        ...
        this.$el = $('<div class="mw-content"></div>').appendTo(this.$parent);
        this.$background = $('<div class="mw-background"></div>').appendTo($("body"));
...
function createTable1(data,parent,tableLevel,callback,option){
    if(option === undefined)  option = {};
        ...
        colList.forEach(function(col,colIndex){
            ...
            if(funArgu.isArray){
                ...
                if(funArgu.isHashInArray){
                    ...
                    if(funArgu.keysOfHashInArray.length === 0){
                        funArgu.keysOfHashInArray = [];
                    }else{
                        funArgu.keysOfHashInArray.reduce(function(a,b){
                            return a.concat(b);
