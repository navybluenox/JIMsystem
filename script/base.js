...
var LocalDate = (function(){
    return class LocalDate {
        ...
        static getOpenTime(day){
            var obj = _val.config.getValue("content.base.openTime")[day-1];
            return {
        ...
        static getWorkTime(day){
            var startDay = _val.config.getValue("content.workAssign.workStart");
            var obj = _val.config.getValue("content.workAssign.workTime")[day-startDay];
            return {
                "start":new LocalDate(obj.start),
                "end":new LocalDate(obj.end)
            };
        ...
        toJSON(){
            return JSON.stringify("local_" + this.getLocalTime());
        }
        toISOString(){
