    ...
    return class Server {
        ...
        sendUpdateQueue(){
            ...
            (new Promise(function(resolve,reject){
                ...
                //TODO that._pendingQueueのキューのうちaddとchangeのものの_id・created補完とupdated更新
                //nowTimeとDatapiece.prototype.setNewId()を利用
                ...
                Promise.all(Object.keys(queueForSend).map(function(dataName){
                    return runServerFun("Script.updateDatabase",queueForSend[dataName]);
                }))
                .then(function(){
