            ...
            return (new Promise(function(resolve,reject){
                ...
                return Promise.all(Object.keys(queueForSend).map(function(dataName){
                    ...
                    return runServerFun("Script.updateDatabase",[
                        that.getCollectionInfoByName(dataName).getDatapieceRelated("fileInfoId","fileInfo").getValue("fileId"),
                        queueForSend[dataName],
                        nowTime.toISOString(),
                        config.getValue("modeName"),
                        {"version":that.getVersion(dataName),"updated":that.getUpdatedTime(dataName).toISOString()}
                    ]);
                }));
            })
            .then(function(){
